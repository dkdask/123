...
export default function LikesPage() {
  ...
  const handleNext = () => {
    // Save liked genres to localStorage for now (will be persisted to DB later)
    localStorage.setItem('likedGenres', JSON.stringify(selectedGenres));
    router.push('/onboarding/dislikes');
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/50 to-gray-900 flex flex-col">
      {/* Header */}
      <div className="p-6 pb-0">
        ...
        >
          ...
          <p className="text-gray-400">
            Select the genres you enjoy. You can choose multiple.
          </p>
        </motion.div>
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-gray-800/50 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            />
          </div>
        </motion.div>
      </div>
